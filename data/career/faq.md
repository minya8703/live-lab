...
**Q. 대용량 트래픽 운영해봤어요?**
A. B2C 수만 RPS급 트래픽 운영 경험은 없습니다. 다만 엔터프라이즈 영역에서 Credit Saison 신용카드 데이터 2,500만 건을 데이터 정합성 이슈 0건으로 처리한 ETL 이관, BeTAX의 Kafka 7개 토픽 비동기 처리, 한샘 EAI 50개 이상 인터페이스 3년간 무장애 운영 경험이 있습니다.
