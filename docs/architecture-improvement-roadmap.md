...
| C-08 | P1 | 대기 | source-claim 의미 검증 | source 파일의 존재뿐 아니라 인용 구간이 답변의 수치·주장을 실제로 뒷받침하는지 평가한다. |
...
또한 실제 source ID를 붙인 미묘한 허위 주장은 C-08의 source-claim 의미 검증이 필요하다. 공격 문자열을
